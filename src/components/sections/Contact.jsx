...
const ContactForm = styled.form`
    ...
    padding: 32px;
    border-radius: 16px;
    box-shadow: 0 10px 30px rgba(53, 48, 42, 0.12);
    margin-top: 28px;
    gap: 12px;
`;
...
const ContactButton = styled.input`
    ...
    background: linear-gradient(135deg, #c2a06a 0%, #a9824f 100%);
    padding: 13px 16px;
    margin-top: 2px;
    border-radius: 12px;
    border: none;
    ...
    &:hover {
        box-shadow: 0 8px 24px rgba(169, 130, 79, 0.4);
...
class Contact extends Component {
    ...
    async handleSubmit(e) {
        ...
        try {
            await emailjs.sendForm("service_afc70nk", "template_eqk4wmq", this.formRef.current, "pyvulSd8SJo2uKgnP");
